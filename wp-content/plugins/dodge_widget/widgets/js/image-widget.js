	...
	dodgeWidget = {
		...
		uploader : function( widget_id, widget_id_string ) {
			...
			frame.on('close',function( ) {
				...
				dodgeWidget.render( widget_id, widget_id_string, attachments[0] );
			});
		...
		render : function( widget_id, widget_id_string, attachment ) {
			...
			$("#" + widget_id_string + 'preview').html(dodgeWidget.imgHTML( attachment ));
			...
			dodgeWidget.toggleSizes( widget_id, widget_id_string );
		},
		...
		changeImgWidth : function( widget_id, widget_id_string ) {
			...
			if ( aspectRatio ) {
				...
				//dodgeWidget.changeImgSize( widget_id, widget_id_string, width, height );
			}
		},
